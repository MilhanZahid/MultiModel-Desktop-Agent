...
class VectorWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("VECTOR Interface")
    ...
    def initUI(self):
        ...
        self.appendMessage("VECTOR", "System online. How may I assist you?")
    ...
    def handleAgentResponse(self, response):
        self.appendMessage("VECTOR", response)
    ...
    def setInteractionEnabled(self, enabled):
        ...
        self.input_field.setPlaceholderText("Enter command or query..." if enabled else "VECTOR is processing...")
